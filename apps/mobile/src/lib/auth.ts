 ...
 * confirmation disabled, this returns a ready-to-use `Session`. When it is
 * enabled, the server returns no tokens and we report that confirmation is
 * still required so the UI can tell the user to check their inbox.
 */
