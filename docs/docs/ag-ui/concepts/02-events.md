...
> **Note:** For the full interrupt lifecycle — the `Interrupt` type, contract rules,
...
> **Warning:** The following events are deprecated and will be removed in version 1.0.0. Use
