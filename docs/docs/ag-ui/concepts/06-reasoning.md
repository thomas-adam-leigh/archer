...
> **Tip:** Unlike Activity messages, Reasoning messages are intended to represent the
...
> **Warning:** The `THINKING_*` events are deprecated and will be removed in version 1.0.0.
