---
url: https://docs.ag-ui.com/quickstart/introduction
---
...
- [Server Implementation](/quickstart/server) — Emit AG-UI events **directly from your agent** or server.

- [Middleware Implementation](/quickstart/middleware) — **Translate existing protocols** and applications to AG-UI events.
